    ...
    <>
      ...
      <div className="flex items-center gap-3 mt-4">
        {authorImageUrl ? (
          <Image
            src={authorImageUrl}
            alt={settings?.name ? `Profile picture of ${settings.name}` : 'Author avatar'}
            width={32}
            height={32}
            sizes="32px"
      ...
      {post.body ? (
        <div className="mt-10 space-y-5 text-neutral-300 leading-relaxed [&_h2]:text-xl [&_h2]:font-semibold [&_h2]:text-white [&_h2]:!mt-10">
